...
interface PropsSVG {
    width?: number
    height?: number
    fill?: { first: string, second: string, third: string }
    rotate?: number
}

const ComponentSVG = ({ width = 800, height = 200, rotate = 0, fill = { first: "#646cffaa", second: "#61dafbaa", third: "#ff7f7faa"} }: PropsSVG) => {
  return (
    <motion.div
        layout
        initial={{ opacity: 0 }}
